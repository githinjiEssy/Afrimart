  ...
  <div class="lg:col-span-4 md:col-span-3 px-[5px] mb-[20px]">
    ...
    <div class="flex justify-center mt-10 space-x-2">
      ...
      <button
        ...
        class="previous-btn px-4 py-2 mx-[10px] text-sm text-[#5D3471] bg-[#E8B6D5] border border-[#AA69AF] rounded-lg hover:bg-[#AA69AF] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1"
      >
