...
<template>
  <div
    class="card bg-white rounded-lg shadow-md overflow-hidden transition-shadow hover:shadow-xl mb-8 relative cursor-pointer"
    @click="navigateToProduct"
  >
    <!-- Move badge here -->
    <span
      v-if="product.isNew"
      class="badge absolute top-3 right-3 bg-yellow-400 text-gray-900 text-xs font-bold px-[6px] py-1 rounded-full z-20 shadow-md"
    >
      NEW
    </span>
